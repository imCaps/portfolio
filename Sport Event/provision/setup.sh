...
echo "Installing MySQL and setting password 1234"
debconf-set-selections <<< "mysql-server mysql-server/root_password password 1234"
debconf-set-selections <<< "mysql-server mysql-server/root_password_again password 1234"
sudo apt-get install mysql-server -y

echo "Installing phpmyadmin and setting password 1234"
...
sudo ln -s /usr/share/phpmyadmin/ /var/www/src/pmants
...
echo "Install libraries for API"
cd /var/www/src/api
